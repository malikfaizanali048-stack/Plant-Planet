      ...
      <div className="container-px mx-auto flex items-center justify-between h-16 gap-4">
        <Link href="/" className="flex flex-col leading-none shrink-0">
          <Image
            ...
            priority
          />
          <span className="text-[10px] tracking-wide text-forest-500 uppercase mt-0.5">
            Wah Green Nurseries
          </span>
        </Link>
        <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-forest-800">
          ...
          <Link href="/our-work" className="hover:text-forest-500">Our Work</Link>
          <Link href="/about" className="hover:text-forest-500">About Us</Link>
          <Link href="/track-order" className="hover:text-forest-500">Track Order</Link>
        </nav>
        <div className="flex items-center gap-4">
          <form
            onSubmit={handleSearch}
            className="hidden sm:flex items-center bg-white rounded-full px-3 py-1.5 border border-sand-200 w-56"
          >
            <Search size={16} className="text-forest-400 mr-2 shrink-0" />
            <input
              type="text"
              value={searchTerm}
